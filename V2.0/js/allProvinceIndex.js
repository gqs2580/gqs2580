...
function returnProvinceData(name){
	if (name == "hubei") return hubeiXY
	if (name == "xinjiang") return xinjiangXY
	if (name == "guangxi") return guangxiXY
	if (name == "xizang") return xizangXY
	if (name == "ningxia") return ningxiaXY
	if (name == "neimenggu") return neimengguXY
	if (name == "sichuan") return sichuanXY
	if (name == "shanxi") return shanxiXY
	if (name == "henan") return henanXY
	if (name == "zhejiang") return zhejiangXY
	if (name == "hainan") return hainanXY
	if (name == "shan_xi") return shan_xiXY
	if (name == "guangdong") return guangdongXY
	if (name == "yunnan") return yunnanXY
	if (name == "guizhou") return guizhouXY
	if (name == "liaoning") return liaoningXY
	if (name == "qinghai") return qinghaiXY
	if (name == "hebei") return hebeiXY
	if (name == "hunan") return hunanXY
	
	if (name == "jiangsu") return jiangsuXY
	if (name == "shandong") return shandongXY
	if (name == "anhui") return anhuiXY
	if (name == "heilongjiang") return heilongjiangXY
	if (name == "fujian") return fujianXY
	if (name == "gansu") return gansuXY
	if (name == "jilin") return jilinXY
	if (name == "jiangxi") return jiangxiXY
...
var guizhouXY = {
	...
	"黔东南布依族苗族自治州": [107.985353, 26.583992],
